...
## Project Structure
    ...
    ├── employee_compliance_42473  # Django project configurations
...
1. Clone this repo and `cd employee_compliance_42473`
...
2. Clone this repo and `cd employee_compliance_42473`
