"""
Django settings for employee_compliance_42473 project.
...
ROOT_URLCONF = 'employee_compliance_42473.urls'
...
WSGI_APPLICATION = 'employee_compliance_42473.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "employee_compliance_42473 API",
    "DESCRIPTION": "API documentation for employee_compliance_42473 App",
    "VERSION": "v1",
}
